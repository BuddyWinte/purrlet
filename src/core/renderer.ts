...
export class Renderer {
  ...
  beginStroke(
    ...
    this.activeStroke = {
      ...
      opacity: 1,
      compositeOperation:
        modeToCompositeOperation(this.mode),
      points: [point],
    };
  ...
  redraw(): void {
    ...
    for (
      const item of this.doc.getItems()
    ) {
